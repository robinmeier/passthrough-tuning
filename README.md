...
- `Tuning root` sets the root MIDI note (0–127, shown as note name e.g. C4). This is the key that plays scale degree 0 at its standard 12-TET pitch. Changing this shifts both the keyboard mapping and the pitch register — e.g. root C4 plays degree 0 at 261 Hz, root A4 plays degree 0 at 440 Hz.
